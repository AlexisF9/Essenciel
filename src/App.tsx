...
function App() {
  ...
  const fetchNearbyCities = async (cp: string) => {
    ...
    const url = `http://api.geonames.org/findNearbyPostalCodesJSON?formatted=true&postalcode=${cp}&country=FR&radius=${searchRadius}&username=${username}&style=full&maxRows=100`;
